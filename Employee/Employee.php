...
.rating:hover>input:checked~label:before {
 ...
 <body>
   ...
   <div class="layout-wrapper layout-content-navbar">
           ...
           <i class="menu-icon tf-icons bx bxs-book-reader"></i>
             ...
             <ul class="menu-sub">
               ...
               <a href=https://www.canva.com/design/DAEghbYC3zA/Vd0SlOs9jwFYjVrgP-_-eQ/view?utm_content=DAEghbYC3zA&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" target=”_blank” class="menu-link">
                   <div data-i18n="Account">Knowing your MP Aqaba City</div>';}
                    else {
                    echo' Tala Bay </div>
             </a>
             <ul class="menu-sub">
    ...
    flex-direction: row;
">
                <span>My Rate:<?php echo ' '. $_SESSION['Rate'];?> </span><div style="color:gold; font-size:large">✮</div> 
              </div>
             <!-- /Search -->
               ...
               <li class="nav-item navbar-dropdown dropdown-user dropdown">
                 <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                   <div class="avatar avatar-online">
                     <img src="../assets/img/avatars/<?php echo  $_SESSION['Emp_ID'].'.'. $_SESSION['Pic'];?>" alt class="w-px-75 h-auto rounded-circle" />
                   </div>
                 </a>
                     ...
                     <a class="dropdown-item" href="#">
                       <div class="d-flex">
                         <div class="flex-shrink-0 me-3">
                           <div class="avatar avatar-online">
                             <img src="../assets/img/avatars/<?php echo  $_SESSION['Emp_ID'].'.'. $_SESSION['Pic'];?>"  alt class="w-px-45 h-auto rounded-circle" />
                           </div>
                         </div>
