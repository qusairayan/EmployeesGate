...
if (isset($_SESSION['Manager_ID'])){
    $result = mysqli_query($connection, "SELECT manager.FirstName,manager.LastName,manager.ID ,manager.Pic ,manager.DepID,manager.Email ,manager.Phone,
     ...
     from manager INNER JOIN department ON department.ID=manager.DepID
      ...
      WHERE manager.ID='" . $_SESSION['Manager_ID']. "'");
...
if (isset($_POST['save'])) {
    ...
    if(isset($fileName))
    {
        if(!empty($fileName))
        {
            ...
            {
                $query=$query='UPDATE manager SET ID = "'.$managIDS.'",FirstName = "'.$firstnameS.'",LastName="'.$lastnameS.'"
                ,Email="'.$emailS.'",Phone="'.$phoneS.'",Pic="'.$extension.'"
                 WHERE manager.ID = "'.$_SESSION['Manager_ID'].'"';
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li >
                      <a class="dropdown-item  open active" href="Profile.php">
...
<div class="input-group">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" name="managID" id="managID" class="form-control"  required placeholder="<?php echo $managID;?>" value="<?php echo $managID;?>" readonly >
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-company2" class="input-group-text">@</span>
                              <input type="email" name="Email" id="Email" class="form-control"  required placeholder="<?php echo $email;?>" value="<?php echo $email;?>"  >
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-company2" class="input-group-text">#</span>
                              <input type="tel" name="Phone" id="Phone" class="form-control"  required placeholder="<?php echo $phone;?>" value="<?php echo $phone;?>"  onkeypress="return /[0-9]/i.test(event.key)"   maxlength="12">
                            </div>
                          </div>
                        </div>
   ...
   const phoneInput = window.intlTelInput(phoneInputField, {
    ...
    $result = mysqli_query($connection, "SELECT * FROM login 
     WHERE Manager_ID='" . $_SESSION['Manager_ID'] . "'");
$row = mysqli_fetch_array($result);
...
$oldPass=$row['password'];
 ...
 ?>
                    ...
                    <input type="hidden" name="managID" class="form-control" value="<?php echo $managID;?>" />
