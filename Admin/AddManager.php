...
if (isset($_POST['Add'])) {
    ...
    if(isset($fileName))
    {
        if(!empty($fileName))
        {
            ...
            if(move_uploaded_file($tempName, $location.$managID.'.'.$extension))
            {

              $query=" INSERT INTO manager (ID,FirstName,LastName,DepID,Pic)  VALUES ( '".$managID."',  '".$firstname."','".$lastname."','".$department."','".$extension."')";
              $query1=" INSERT INTO login (Manager_ID,Password,RoleID)  VALUES ( '".$managID."',  'a12345',1)";
              
                  
              
                  if(mysqli_query($connection,$query) && mysqli_query($connection,$query1)){
                      echo '<script type="text/javascript">'; 
                      echo 'alert("Manager Added successfully ✓ ");'; 
                      echo 'window.location.href = "ManagProfile.php?managIDedit='.$managID.'"';
                      echo '</script>';
...
$query=" INSERT INTO manager (ID,FirstName,LastName,DepID)  VALUES ( '".$managID."',  '".$firstname."','".$lastname."','".$department."')";
$query1=" INSERT INTO login (Manager_ID,Password,RoleID)  VALUES ( '".$managID."',  'a12345',1)";
    ...
    if(mysqli_query($connection,$query) && mysqli_query($connection,$query1)){
       ...
       if(mysqli_errno($connection) == 1062){
           echo '<script>alert("Duplicated ID ( '.$managID.' ) entered ")</script>';
           $_POST = array();}
       else{
        echo '<script>alert("Manager information update failed  Error ( '.mysqli_errno($connection).' ) ")</script>';
        $_POST = array();
    }
                  ...
                  <div class="nav-align-top mb-4">
                    <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                      <li class="nav-item">
                        ...
                        <i class="tf-icons bx bx-user-plus"></i> Add New Manager
                        </button>
                      </li>
...
<div class="input-group">
                        ...
                        <input type="text" aria-label="First name" class="form-control"  name="first_name" id="first_name" required placeholder="Enter Manager's Firstname" >
                        <input type="text" aria-label="Last name" class="form-control"  name="last_name" id="last_name" required required placeholder="Enter Manager's Lastname" >
                      </div>
                                  </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" name="managID" id="managID" class="form-control"  required placeholder="Enter Manager's ID"  >
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            ...
                            <select class="form-select" name="Department" id="Department"   required  >
                                <option disabled selected hidden value="">Enter Manager's Department</option>
                            <?php 
