   ...
   <div class="col-lg-4 col-md-3">
    ...
    color: #8e91fc;"> <i class="bx bxs-message-alt-add"></i></h5>
                    ...
                    style="width:100%">
                          ...
                          <option value="Best Smile">Best Smile</option>
                          <option value="Best Grooming and appearance">Best Grooming and appearance</option> 
                          <option value="Delivering HEARTIST Stories to guest/employee">Delivering HEARTIST Stories </option>
                          <option value="Guest feedbak">Guest feedbak</option>
                          <option value="Adhering to Sustainability(Planet 21)">Sustainability(Planet 21)</option>
                          <option value="Commit to Brand Standards">Commit to Brand Standards</option>
                          <option value="Knowing the hotel services ( product Knowledge)">Knowing the hotel services</option>
                          <option value="Teamwork">Teamwork</option>
                          <option value="Creative ideas">Creative ideas</option>
                          <option value="Active E-learner on INES Platform">Active E-learner</option>
...
<br>
                        ...
                        <label for="upload" class="btn btn-primary me-2 " tabindex="0">
                            ...
                            <input type="file" name="img" id="upload" class="account-file-input" hidden="" accept="image/png, image/jpeg" onchange="javascript:updateList()" required>
                          </label></span>
...
if(document.getElementById('category').value=='Best Smile'){
...
else if(document.getElementById('category').value=='Best Grooming and appearance') { 
   document.getElementById(1).checked = true;
...
else if(document.getElementById('category').value=='Teamwork') { 
   document.getElementById(2).checked = true;

}


else if(document.getElementById('category').value=='Commit to Brand Standards') { 
   document.getElementById(2).checked = true;

}

else if(document.getElementById('category').value=='Delivering HEARTIST Stories to guest/employee') { 
   document.getElementById(3).checked = true;

}
else if(document.getElementById('category').value=='Guest feedbak') { 
   document.getElementById(3).checked = true;

}

else if(document.getElementById('category').value=='Adhering to Sustainability(Planet 21)') { 
   document.getElementById(2).checked = true;

}

else if(document.getElementById('category').value=='Knowing the hotel services ( product Knowledge)') { 
   document.getElementById(2).checked = true;

}
else if(document.getElementById('category').value=='Creative ideas') { 
   document.getElementById(2).checked = true;

}
else if(document.getElementById('category').value=='Active E-learner on INES Platform') { 
   document.getElementById(2).checked = true;
