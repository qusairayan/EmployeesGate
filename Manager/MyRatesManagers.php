          ...
          <ul class="menu-inner py-1">
            ...
            <?php if ($_SESSION['Manager_ID'] == 1704) {
              ...
              <a href="MyRates.php" class="menu-link">
                <div data-i18n="Account">My Rates <small class="text-muted"> -Employyes</small></div>
              </a>
            </li>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="layout-demo-wrapper">
                ...
                <div class="card">
                <h5 class="card-header">Employees have been rated by you:
                  <?php
$sql="SELECT COUNT(*) as total FROM manager_rate WHERE manager_rate.From='".$_SESSION['Manager_ID']."'";
...
{
 $query = "
 SELECT * FROM manager_rate
 INNER JOIN manager ON manager.ID =manager_rate.To
 WHERE manager_rate.From ='".$_SESSION['Manager_ID']."'
...
if(mysqli_num_rows($result) > 0)
{
...

 {
  ...
  <td>
    <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
      <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" >
        <img src="../assets/img/avatars/'.$row["To"].'.jpeg" alt="Avatar" class="rounded-circle">
      </li>
     
    </ul>
  </td>
  <td> <strong id="firstName'.$row["To"].'">'.$row["FirstName"]
  ...
  <td> <strong id="Time'.$row["To"].'">'.$row["date_time"].'</strong></td>
