...
<div class="btn-group" role="group">
                             ...
                             <a href="Ar/index.php"><button type="button" class="btn">عربي</button></a>
                            </div>
    </div>                      </div>
...
<div class="inp">
<input  name="ID" type="number" placeholder="Enter Your ID" />
...
?>
 ...
 <div class='alert'> Welcome to the daily Heartsits' Gate  <br> 
   to assess your performance and skills toward each guest 
  </div>
