...
if (isset($_POST['save'])) {
 ...
 if(mysqli_errno($connection) == 1062){
  ...
  echo '<script>alert("فشل الحفظ ( '.mysqli_errno($connection).' ) ")</script>';
  $_POST = array();
}
...
WHERE ID = '.$_SESSION['Emp_ID'].';';
    ...
    if(mysqli_query($connection,$query)){
       ...
       if(mysqli_errno($connection) == 1062){
        ...
        echo '<script>alert("فشل الجفظ  Error ( '.mysqli_errno($connection).' ) ")</script>';
        $_POST = array();
    }
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="layout-demo-wrapper">
                ...
                <div class="card">
                <h5 class="card-header">ملفي الشخصي</h5>
                  ...
                  <div class="nav-align-top mb-4">
                    <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                      <li class="nav-item">
                        ...
                        <i class="tf-icons bx bx-user"></i> الملف الشخصي
                        </button>
                      </li>
                      ...
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        ...
                        <div class="button-wrapper">
                          <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                            <span class="d-none d-sm-block">نحميل صورة جديدة</span>
...
<hr>
                        ...
                        <div class="row mb-3">
                          ...
                          <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">الأسم</label>
                          <div class="col-sm-10">
                           

<div class="input-group">
                        <span class="input-group-text"><i class="bx bx-user"> </i>  الأسم الأول , الأسم الأخير </span>
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="managID" >الرقم الوظيفي</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-company2" class="input-group-text">#</span>
                              <input type="text" name="managID" id="managID" class="form-control"  required placeholder="<?php echo $_SESSION['Emp_ID'];?>" value="<?php echo $_SESSION['Emp_ID'];?>" readonly >
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-end">
                          <div class="col-sm-10">
                            <button type="submit" name="save" class="btn btn-primary"> حفظ  <i class="fas fa-check-circle"></i></button>
