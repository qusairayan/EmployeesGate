 ...
 <body>
           ...
           <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse" >
             ...
             <div class="navbar-nav align-items-center"  style="width: 100%;">
                <div class="nav-item d-flex align-items-center" style="width: 100%;">
                  ...
                  <input type="text" class="form-control border-0 shadow-none" name="search_text" id="search_text" placeholder="البحث" aria-label="بحث..." style="background:transparent;">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="layout-demo-wrapper">
                ...
                <div class="card">
                <h5 class="card-header">أبحث عن مدير لتقييمه</h5>
   ...
   <div class="col-lg-4 col-md-3">
    ...
    color: #8e91fc;"> <i class="bx bxs-message-alt-add"></i></h5>
                    ...
                    style="width:100%">
                            <option value="" disabled selected hidden>التصنيف..</option>
...
<br>
                        ...
                        <textarea name="user_review" id="user_review"  class="form-control" style="color:white; background: #2f3a3f;"  placeholder="تفاصيل التقييم" required></textarea>
                      </div>
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="submit" name="addRate" id="addRate" class="btn btn-primary"> تقييم</button></form>
                            </div>
                          </div>
                        </div>
                      </div>
