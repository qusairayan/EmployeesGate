...
if($_SESSION['inserted']){
    ...
    echo 'alert("'.$_SESSION['ename'].' Rated successfully ✓ ");'; 
    echo '</script>';
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="AddManagaer.php" class="menu-link">
...
if(document.getElementById('category').value=='Smile'){
...
else if(document.getElementById('category').value=='Grooming') { 
   document.getElementById(1).checked = true;
...
else if(document.getElementById('category').value=='Team working') { 
   document.getElementById(2).checked = true;

}


else if(document.getElementById('category').value=='Standards') { 
   document.getElementById(2).checked = true;

}

else if(document.getElementById('category').value=='Heartist') { 
