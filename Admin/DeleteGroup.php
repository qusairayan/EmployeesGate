...
<div class="logout">
        ...
        <div class="layout-page">
              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  ...
                  <input
                    ...
                    placeholder="Search by Employee Details"aria-label="Search..."
                    />
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y" style="    padding-bottom: 0rem !important;
    padding-top: 0rem !important;">
              ...
              <div class="layout-demo-wrapper">
                ...
                <div class="card">
                <h5 class="card-header">Delete Employees </h5>
                ...
                <form id="form" method="post" action="DeleteGroupSubmit.php">
<div id="result">
...
<button style="
 ...
 border-color: #83b3ff;
" type="submit" class="btn btn-primary" id="submit"> Delete</button>  </from> 
