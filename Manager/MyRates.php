            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="layout-demo-wrapper">
                ...
                <h5 class="card-header">Employees have been rated by you:
                  <?php
$sql="SELECT COUNT(*) as total FROM rate WHERE ManagID='".$_SESSION['Manager_ID']."'";
...
else
{
 ...
 WHERE ManagID ='".$_SESSION['Manager_ID']."'
...
if(mysqli_num_rows($result) > 0)
{
...

 {
  ...
  <td> <strong id="Time'.$row["EmpID"].'">'.$row["date_time"].'</strong></td>
